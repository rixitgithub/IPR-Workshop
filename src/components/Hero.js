...
import HeroImage from "../media/main1.jpg";
...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const parallaxAnimate = () => {
      ...
      coordinatorNames.style.transform =
        "translate3d(0, " + speed * coordNamesTopOffset.toFixed(3) + "px, 0)";
    };
    ...
    <div className={styles.hero} id="hero">
      ...
      <div className={styles.content}>
        <h1 className={styles.logo}>
          <span className="shouldAnimate">R</span>
